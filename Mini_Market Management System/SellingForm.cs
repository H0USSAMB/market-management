...
namespace Mini_Market_Management_System
{
    public partial class SellingForm : Form
    {
        ...
        {
            string selectQuerry = "SELECT ProdNom, ProdPrix FROM Produit";
            SqlCommand command = new SqlCommand(selectQuerry, dBCon.GetCon());
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            DataTable table = new DataTable();
            adapter.Fill(table);
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Commande ajoutée avec succès", "Informations sur la commande", MessageBoxButtons.OK, MessageBoxIcon.Information);
                dBCon.CloseCon();
                getSellTable();
        ...
        private void button_print_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "Listes de vente SKOOLASHOPt";
        ...
        {
            string selectQuerry = "SELECT ProdNom, ProdPrix FROM Produit WHERE ProdCat='" + comboBox_category.SelectedValue.ToString() + "'";
            SqlCommand command = new SqlCommand(selectQuerry, dBCon.GetCon());
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            DataTable table = new DataTable();
            adapter.Fill(table);
        ...
        private void button_addOrder_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                grandTotal += Total;
                label_amount.Text = grandTotal + " DH";
            }
        }
    }
}
